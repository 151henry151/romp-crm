defmodule RompCrmWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RompCrmWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RompCrmWeb.Gettext, "errors", msg, opts)
    end
  end
