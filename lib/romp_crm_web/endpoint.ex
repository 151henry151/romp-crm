defmodule RompCrmWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :romp_crm
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :romp_crm
  end
