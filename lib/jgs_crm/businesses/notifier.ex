defmodule JgsCrm.Businesses.Notifier do
  @moduledoc false
  import Swoosh.Email

  alias JgsCrm.Mailer
  alias JgsCrm.Businesses.{Business, BusinessInvitation}

  defp deliver(recipient, subject, body) do
    from_name = Application.get_env(:jgs_crm, :mail_from_name, "Romp CRM")
  ...
  def deliver_invitation(%BusinessInvitation{} = invitation, %Business{} = business, accept_url) do
    ...
    This invitation expires in #{JgsCrm.Businesses.BusinessInvitation.token_validity_in_days()} days.
