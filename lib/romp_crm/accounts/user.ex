defmodule RompCrm.Accounts.User do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    belongs_to :selected_business, RompCrm.Businesses.Business, foreign_key: :selected_business_id
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, RompCrm.Repo)
    ...
    case get_change(changeset, :phone) do
      ...
      phone ->
        case String.trim(to_string(phone)) do
          ...
          trimmed ->
            norm = RompCrm.Twilio.Phone.normalize_us(trimmed)
  ...
  """
  def valid_password?(%RompCrm.Accounts.User{hashed_password: hashed_password}, password)
