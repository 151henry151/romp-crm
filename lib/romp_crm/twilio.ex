defmodule RompCrm.Twilio do
  ...
  Expects `Application.get_env(:romp_crm, :twilio_sms_allowed_from_normalized)` to be a list of
  ...
  def sms_sender_allowed?(from) when is_binary(from) do
    allowed = Application.get_env(:romp_crm, :twilio_sms_allowed_from_normalized, [])
