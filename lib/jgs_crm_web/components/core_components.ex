defmodule JgsCrmWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: JgsCrmWeb.Gettext
  ...
  ## Examples
      ...
      <.modal id="confirm-modal" show on_cancel={JS.patch(~p"/")}>
        Are you sure?
      </.modal>
  """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(JgsCrmWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(JgsCrmWeb.Gettext, "errors", msg, opts)
    end
  end
